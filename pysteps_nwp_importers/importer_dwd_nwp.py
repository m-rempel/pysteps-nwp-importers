...
def import_dwd_nwp(filename, **kwargs):
    ...
    # accumulated since forecast initialization. Set it to the temporal resolution if
    # it is a variable accumulated within two time steps. Otherwise set it to None.
